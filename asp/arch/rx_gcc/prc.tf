...
$TAB$ .word$TAB$ 00000003 $TAB$ ; 0xFFFFFF9C ROM code(0xFFFFFF9C) $NL$
$TAB$ .word$TAB$ 00000000 $TAB$ ; 制御コード(0xFFFFFFA0), IDコード1 - 3$NL$
$TAB$ .word$TAB$ 00000000 $TAB$ ; IDコード4 - 7$NL$
$TAB$ .word$TAB$ 00000000 $TAB$ ; IDコード8 - 11$NL$
$TAB$ .word$TAB$ 00000000 $TAB$ ; IDコード12 - 15$NL$$NL$
