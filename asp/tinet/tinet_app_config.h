...
#if 1
#define IPV4_ADDR_REMOTE		MAKE_IPV4_ADDR(192,168,1,12)
#else
...
#define IPV4_ADDR_LOCAL			MAKE_IPV4_ADDR(192,168,11,21)
#define IPV4_ADDR_LOCAL_MASK		MAKE_IPV4_ADDR(255,255,255,0)
#define IPV4_ADDR_DEFAULT_GW		MAKE_IPV4_ADDR(192,168,11,12)
